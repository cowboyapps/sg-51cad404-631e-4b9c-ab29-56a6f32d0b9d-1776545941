...
export default function PublicBusinessSite() {
  ...
  useEffect(() => {
    if (slug) {
      loadBusinessData(slug as string);
    }
  }, [slug]);

  const loadBusinessData = async (businessSlug: string) => {
    try {
      // Load business
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 4. Create subscription (credentials auto-generated by trigger)
      ...
      <div className="min-h-screen flex items-center justify-center bg-background">
        <Card className="max-w-md">
          <CardContent className="pt-12 pb-12 text-center">
            ...
            <h2 className="font-heading font-semibold text-xl mb-2">Business Not Found</h2>
            <p className="text-muted-foreground">
              This IPTV service doesn't exist or is currently unavailable.
            </p>
          </CardContent>
        </Card>
      </div>
